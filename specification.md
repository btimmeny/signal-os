...
| FR-36 | Provide a GET /tasks endpoint that returns pre-formatted markdown text ready for verbatim display by AI agents | Implemented |
...
| GET | `/tasks` | Pre-formatted markdown task list (preferred for display) |
| GET | `/commitments/dashboard` | Structured JSON organized view of all open tasks |
...
| 021 | Strategic Signal System | [`features/021-strategic-signal-system`](features/021-strategic-signal-system/specification-feature-strategic-signals.md) | 2026-03-16 | Auto-generates Strategic Contribution Notes on task open and Execution Impact Notes on task close. Records signals with initiative/theme context, high-signal classification, and category. Feeds into Friday updates and memos. |
| 022 | Strategic Execution Intelligence | [`features/022-strategic-execution-intelligence`](features/022-strategic-execution-intelligence/specification-feature-strategic-intelligence.md) | 2026-03-16 | Converts task activity into strategic insight with durable memory. 5 new tables for contribution notes, impact notes, strategic narratives, confidence history, and weekly narrative drafts. Scheduled Friday 12 PM updates via APScheduler. Strategy Confidence Score (0-100) with trend tracking. Three narrative framings per week. Session-independent operation. |
